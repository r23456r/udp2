...
public class AESUtil {
    ...
    private final int invmcol(int x) {
        int f2 = ffmulX(x);
        int f4 = ffmulX(f2);
        int f8 = ffmulX(f4);
        int f9 = x ^ f8;
    ...
    public static String encode(String source, String key) {
        ...
        datas = aesUtil.encode(datas, key.getBytes());
        return Hex.encodeHexString(datas);
    }

    public static String encode(String source) {
        return encode(source, AES_KEY);
    }
    ...
    public static void main(String[] args) {
        ...
        String enter = "91f12936253fd6c9f236fb949b9f175c";
        String halt = "INDUSTRIALVD_2020%dispose_api%#!=";
        System.out.println(encode(enter + "," + currentTimeMillis + "," + halt));
    }
}
