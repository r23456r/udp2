...
public class DateUtils {
     ...
     * @return
     */
    public static Date formatYearStr(String str) throws ParseException {
        return formatYearStr(str, MONTH_FORMAT);
    }

    public static Date formatYearStr(String str, String pattern) throws ParseException {
        LocalDate aLD = LocalDate.parse(str + "-01");
        return fromLocalDate(aLD);
    }

    public static Date formatQuarterStr(String str) throws ParseException {
        return formatQuarterStr(str, WEEK_FORMAT_E);
    }

    public static Date formatQuarterStr(String str, String pattern) throws ParseException {
    ...
    public static Date formatMonthStr(String str) throws ParseException {
        return formatMonthStr(str, DAYS_FORMAT);
    }

    public static Date formatMonthStr(String str, String pattern) throws ParseException {
